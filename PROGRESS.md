...
- [~] `M-06` Add staging/prod moderation drill covering report -> flag -> triage -> enforcement -> audit verification (automation implemented via `pnpm moderation:drill`; execute against staging/prod to close fully).
