  ...
  en: {
    ...
    landing: {
      ...
      finalCta: {
        ...
        consentPrefix: "By joining, you agree to the",
        terms: "Terms",
        consentJoin: "and acknowledge the",
  ...
  es: {
    ...
    landing: {
      ...
      finalCta: {
        ...
        consentPrefix: "Al unirte, aceptas los",
        terms: "Términos",
        consentJoin: "y reconoces la",
  ...
  fr: {
    ...
    landing: {
      ...
      finalCta: {
        ...
        consentPrefix: "En rejoignant la liste, vous acceptez les",
        terms: "Conditions",
        consentJoin: "et reconnaissez la",
